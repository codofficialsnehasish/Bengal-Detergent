...
class Leave_type_master extends Core_Controller {

	public function __construct()
    {
        parent::__construct();
		$this->is_not_logged_in();
		$this->table_name='leave_type_master';
		$this->view_path='employee_management/master_data_manage/leave_type_master/';
	...
	public function index()
	{
		...
		$header['title']='Leave Type Master';
	...
	{
		$header['pagecss']="";
		$header['title']='Add New Leave Type';
		$this->load->view('employee_management/partialss/header',$header);
		$data['categories']='';
