                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h6 class="page-title">Weekly Holiday</h6>
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Weekly Holiday</li>
                                    </ol>
                                </div>
                                <!-- <div class="col-md-4">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?= $item->dayname;?></td>
                                                    <td>
                                                        <a href="<?= employee_url('leave/update_weekly_holiday/'.$item->wk_id);?>" class="btn btn-primary btn-sm edit" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit this Item">
