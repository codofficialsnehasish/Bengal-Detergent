            ...
            <form class="row g-3 custom-validation" id="salaryconfigForm" method="post" novalidate>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="pfContribution" placeholder="0.00"  name="provident_fund" value="<?= !empty($salary_config->provident_fund) ? $salary_config->provident_fund : '' ;?>" onkeyup="calculatePayingInHand()">
                    </div>
                    <div class="mb-3">
