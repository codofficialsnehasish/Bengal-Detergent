<div class="page-content">
   <div class="container-fluid">
         ...
         <div class="row align-items-center">
            <div class="col-md-8">
               ...
               <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item"><a href="<?= employee_url('master-manage/designation-master/')?>">Leave Type Master</a></li>
            ...
            <div class="col-md-4">
               <div class="float-end d-none d-md-block">
                  <div class="dropdown">
                     <a href="<?= employee_url('master-manage/leave-type-master/')?>" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
      ...
      <!-- end page title -->
      <?= form_open_multipart('employee-management/master-manage/leave-type-master/update-process/'.$item->id, 'class="custom-validation"');?>
                     ...
                     <div class="mb-3">
                        ...
                        <div>
                           <input data-parsley-type="number" type="number"
                              class="form-control" required
                              placeholder="Enter Leave Days" name="no_of_days" value="<?= $item->no_of_days;?>" value="" required>
                        </div>
                     </div>
                  </div>
               </div>
