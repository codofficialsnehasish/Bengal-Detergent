<div class="page-content">
   <div class="container-fluid">
      ...
      <!-- </div> -->
      <!-- end page title -->
      <?= form_open_multipart('employee-management/master-manage/leave-in-designation/process', 'class="custom-validation"');?>
      
         <div class="row">
            <div class="col-lg-9">
               <div class="card">
                    <div class="card-header bg-primary text-light">
                        Assign Leave for Designation
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <input type="number" name="no_of_days" class="form-control" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
               </div>
