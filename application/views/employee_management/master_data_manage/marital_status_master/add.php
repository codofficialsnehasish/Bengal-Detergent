<div class="page-content">
   <div class="container-fluid">
         ...
         <div class="row align-items-center">
            <div class="col-md-8">
               ...
               <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item"><a href="<?= employee_url('master-manage/marital-status-master')?>">Shift Master</a></li>
      ...
      <!-- end page title -->
      <?= form_open_multipart('employee-management/master-manage/marital-status-master/process', 'class="custom-validation"');?>
