<div class="page-content">
   <div class="container-fluid">
         ...
         <div class="row align-items-center">
            <div class="col-md-8">
               ...
               <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item"><a href="<?= employee_url('master-manage/designation-master')?>">Designation Master</a></li>
            ...
            <div class="col-md-4">
               <div class="float-end d-none d-md-block">
                  <div class="dropdown">
                     <a href="<?= employee_url('master-manage/designation-master/')?>" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
      ...
      <!-- </div> -->
      <!-- end page title -->
      <?= form_open_multipart('employee-management/master-manage/designation-master/process', 'class="custom-validation"');?>
                  ...
                  <div class="mb-3">
                        ...
                        <div>
                           <input data-parsley-type="number" type="number"
                              class="form-control" required
                              placeholder="Enter Leave Days" name="leave_days" value="" required>
                        </div>
                     </div>
                   </div>
               </div>
