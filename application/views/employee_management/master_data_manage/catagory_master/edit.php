<div class="page-content">
   <div class="container-fluid">
         ...
         <div class="row align-items-center">
            <div class="col-md-8">
               ...
               <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item"><a href="<?= employee_url('master-manage/catagory-master/')?>">Catagory Master</a></li>
            ...
            <div class="col-md-4">
               <div class="float-end d-none d-md-block">
                  <div class="dropdown">
                     <a href="<?= employee_url('master-manage/catagory-master/')?>" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
      ...
      <!-- end page title -->
      <?= form_open_multipart('employee-management/master-manage/catagory-master/update-process/'.$item->id, 'class="custom-validation"');?>
