<div class="page-content">
   <div class="container-fluid">
         ...
         <div class="row align-items-center">
            <div class="col-md-8">
               ...
               <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item"><a href="<?= employee_url('master-manage/how-to-know-master/')?>">How To Know Master</a></li>
      ...
      <!-- end page title -->
      <?= form_open_multipart('employee-management/master-manage/how-to-know-master/update-process/'.$item->id, 'class="custom-validation"');?>
