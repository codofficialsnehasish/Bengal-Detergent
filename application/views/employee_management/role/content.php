                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4">
                                    <div class="float-end d-none d-md-block">
                                        <div class="dropdown">
                                        <a href="<?= employee_url('role/add-new')?>" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
                                    ...
                                    <div class="card-body">
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?= $i++;?></td>
                                                    <td><a href="<?= employee_url('role/edit/'.$item->id);?>"><?= $item->name;?></a></td>
                                                    <td><?= check_visibility($item->is_visible);?> </td>
                                                    <td><?= formated_date($item->created_at);?></td>
                                                    <td>
                                                        <a href="<?= employee_url('role/edit/'.$item->id);?>" class="btn btn-primary btn-sm edit" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit this Item">
