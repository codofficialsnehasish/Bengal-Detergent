        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <?php if($this->auth_user->role == "employee"){ ?>
                    ...
                    <li class="<?= active_menu('stocks');?>">
                        <a href="<?= check_todays_attendance($this->auth_user->id) != "Check Out" ? employee_url('attendance/emp-attendance/') : 'javascript:void(0)'; ?>" class="waves-effect <?= active_link('stocks');?>">
